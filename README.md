...
- **Hybrid Search**: Combines keyword-based search (BM25) and semantic vector search to enhance retrieval accuracy, allowing for a more precise understanding of user intent and finding more relevant documents.
